...
const (
	defaultKafkaClientID       = "discord-kafka-week-formatter"
	defaultKafkaConsumerGroup  = "discord-kafka-week-formatter"
...
func Load() (Config, error) {
	...
	if cfg.KafkaTelegramTopic, err = requiredEnv("KAFKA_TELEGRAM_WEEK_TOPIC"); err != nil {
		return Config{}, err
	}
	cfg.KafkaConsumerGroup = optionalEnv("KAFKA_WEEK_CONSUMER_GROUP", defaultKafkaConsumerGroup)
	cfg.KafkaClientID = optionalEnv("KAFKA_WEEK_CLIENT_ID", defaultKafkaClientID)
