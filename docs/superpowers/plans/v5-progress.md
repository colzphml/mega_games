...
| V5-30 Миграция и выкатка | ✅ | `v5/30-release` | выкачено 2026-08-01 |
...
| V5-36 Тесты на непокрытые места | ✅ | `v5/36-test-gaps` | 12402e7 |
| V5-37 Воскрешение статуса в TG-отправителе | ✅ | `v5/37-status-resurrection` | 4d64d4c |
